 ...
 * @LastEditTime: 2022-09-21 21:09:28
 */
import request from '@/utils/http';
import { AssetsView, HostView, AssetsViewDetail, HostViewDetail } from '../model/assetsModel';

enum Api {
  assetview = '/api/asset/jar/assetview',
  assetview_detail = '/api/asset/jar/detail/assetview',
  hostview = '/api/asset/jar/hostview',
  hostview_detail = '/api/asset/jar/detail/hostview',
  assetview_axpand = '/api/asset/jar/detail/assetexpand',
...
/**
 * @description: "获取jar包祥细列表：资产视图—详细信息子列"
 */
