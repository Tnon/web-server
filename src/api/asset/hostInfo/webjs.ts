...
enum Api {
  assetview = '/api/asset/webjs/assetview',
  assetview_detail = '/api/asset/webjs/detail/assetview',
  hostview = '/api/asset/webjs/hostview',
  hostview_detail = '/api/asset/webjs/detail/hostview',
  assetview_axpand = '/api/asset/webjs/detail/assetexpand',
}

/**
 * @description: "获取js接口列表：资产视图"
 */
...
/**
 * @description: "获取js接口祥细列表：资产视图—详细信息子列"
 */
