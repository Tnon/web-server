<template>
  <div class="maincontent">
    <div class="header">
      <span class="title">{{ t('operation.behaviorLog') }}</span>
      <!-- 导出 start -->
      <export-data api="/api/report/event" :params="agms" class="exportIc" />
      <!-- 导出 end -->
    </div>
    <div class="container">
      <!-- 左侧筛选 start -->
...
<script lang="ts" setup>
  ...
  import { getEveOptions, getEveLogList } from '@/api/operation/log';
