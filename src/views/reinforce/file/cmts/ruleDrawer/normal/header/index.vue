 ...
 * @LastEditTime: 2023-07-24 16:05:12
-->
<template>
  <div class="header">
    <!-- 危险等级 start -->
...
<script lang="ts" setup>
  ...
  import { E_Reinforce_Type, HandleType } from '../../../tableContent/type';
        ...
        useModal(
          {
            ...
            handleOk: async () => {
              await batchHandleFile({
                filter: { handle: props.handle, risk_type: E_Reinforce_Type.File },
                isall: false,
  ...
  const text = ref('');
  watchEffect(() => {
    text.value = Pstatus[props.handled];
  });
</script>
