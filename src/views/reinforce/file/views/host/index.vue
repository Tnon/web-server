 ...
 * @LastEditTime: 2023-10-12 12:01:46
-->
<template>
  <div class="userContainer">
    <div class="header">
      ...
      <div class="tools">
        ...
        <div class="line"></div>
        <!-- 导出 start -->
        <export-data api="/api/report/fmrulehostlist" :params="agms" class="exportIc" />
        <!-- 导出 end -->
      </div>
    </div>
    <slots-table
      ...
      :get-list-func="getBlRuleHostList"
    />
  </div>
</template>
...
<script lang="ts" setup>
  ...
  import { getBlRuleHostList } from '@/api/reinforce';
