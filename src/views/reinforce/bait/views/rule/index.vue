 ...
 * @LastEditTime: 2023-10-12 12:01:28
-->
<template>
  <div class="userContainer">
    <div class="header">
      ...
      <div class="backtext" @click="goBack">
        ...
        {{ t('reinforce.monitored_bait_rule') }}：
      ...
      <div class="tools">
        ...
        >
          ...
          {{ t('reinforce.newruleaa') }}
        </a-button>
        <!-- 新建规则 end -->

        <div class="line"></div>
        <!-- 导出 start -->
        <export-data api="/api/report/dfrulelist" :params="agms" class="exportIc" />
        <!-- 导出 end -->
      </div>
    </div>
    <slots-table
...
<script lang="ts" setup>
  ...
  import { getBlRuleListDf } from '@/api/reinforce';
