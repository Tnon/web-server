 ...
 * @LastEditTime: 2023-07-24 16:07:58
-->
<template>
  <div class="footer">
...
<script lang="ts" setup>
  ...
  import processInfoList from '@/components/attack-risk-cmts/attackDrawer/normal/footer/cmts/process_info_list';
  ...
  const dymicTab = ref<any>([
    ...
    {
      title: t('arcomn.process_tree'),
      type: 'process_info_list',
    },
    {
