 ...
 * @LastEditTime: 2023-10-12 12:01:20
-->
<template>
  <div class="userContainer">
    <div class="header">
      ...
      <div class="tools">
        ...
        <div class="line"></div>
        <!-- 导出 start -->
        <export-data api="/api/report/filetamperinfo" :params="agms" class="exportIc" />
        <!-- 导出 end -->
      </div>
    </div>
    <slots-table
...
<script lang="ts" setup>
  ...
  import {
    ...
    HandleType,
    I_File_Filter,
  } from '@/views/reinforce/file/cmts/tableContent/type';
  ...
  //搜索数据源
  const agms = reactive<I_File_Filter>({
    //处理类型
    ...
    op_list: '',
    //文件 还是 诱饵
    risk_type: E_Reinforce_Type.Bait,
  });
  //刷新表格的方法
  ...
  watch(
    ...
    () => {
      refreshTable();
      boxType.value = '';
      columns.value = useColumns(t, refreshTable, agms.handle);
    },
  );
