 ...
 * @LastEditTime: 2023-03-13 17:28:50
-->
<template>
  <div class="userContainer">
    <div class="header">
      ...
      <div class="rightOp">
        <!-- 高级筛选 start -->
        <advanSearch class="filters" :params="agms" :rule_code="rule_code" @confirm="btnConfirm" />
        <!-- 高级筛选 end -->
...
<script lang="ts" setup>
  ...
  import { getTaskCheck } from '@/api/reinforce';
  ...
  //搜索数据源
  const agms = reactive<I_Check_Filter>({
    //id
  ...
  const columns = useColumns(t, props.session_id);
