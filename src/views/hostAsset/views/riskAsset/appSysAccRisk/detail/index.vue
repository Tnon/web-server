  ...
  <div class="dcontent">
    <div class="header">
      <span class="title" @click="goBack">
        ...
        <span class="titmsg" v-if="view === 'Pro'"> {{ t('asset.accountRisk' + type) }}：</span>
...
<script lang="ts" setup>
  ...
  const { title, host_id, type, view, logoType, uuid } = currentRoute.query as any;
  const columns: TableColumn[] = getapi_columnsDetail('' + type + view, t, uuid, host_id);
